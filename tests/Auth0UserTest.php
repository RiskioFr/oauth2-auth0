...
use Riskio\OAuth2\Client\Provider\Auth0User;
...
class Auth0UserTest extends \PHPUnit_Framework_TestCase{
    ...
    public function testGetUserDetails(){
        $user = new Auth0User($this->response);
    ...
    public function testNullValueIsCorrectlyHandled(){
        unset($this->response['nickname']);
        $user = new Auth0User($this->response);
        $nickname = $this->assertEquals(null,$user->getNickname());
    }
